...
## Documentation
Look at one of example files available in the **examples** directory \[[PDF version](examples/jlreq-article-tate.pdf)\] and also the documentation of the *jlreq* LaTeX class itself. Note that the lyx file in the examples directory is only readable with LyX versions greater than LyX-2.4.0-beta3.
